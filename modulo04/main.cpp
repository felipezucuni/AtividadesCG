...
int main()
{
	...
	int nVerts;
	GLuint VAO = loadSimpleOBJ("textures/suzanneTriLowPoly.obj", nVerts, glm::vec3(0.0, 1.0, 1.0));
	GLuint VAO2 = loadSimpleOBJ("textures/suzanneTriLowPoly.obj", nVerts);
	GLuint VAO3 = loadSimpleOBJ("textures/suzanneTriLowPoly.obj", nVerts, glm::vec3(1.0, 1.0, 0.0));
...
int setupGeometry()
{
	...
	//Geração do identificador do VBO e VAO
	glGenBuffers(1, &VBO);
